...
app.controller('myAppVisualizzaCartaCompetenzaCtrl',['$scope','$rootScope', '$routeParams', '$location', 'Brevetti', 'CartaCompetenza', 'CartaSpecialita', 'Utente',
    function($scope, $rootScope, $routeParams, $location, Brevetti, CartaCompetenza, CartaSpecialita, Utente ){
    $scope.dati={}
